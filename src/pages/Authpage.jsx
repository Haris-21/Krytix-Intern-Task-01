...
const Authpage = () => {
      ...
      case "login":
        return (
          <form onSubmit={handleDummySubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full bg-violet-500 text-white xl:mt-15 lg:mt-15 md:mt-4 p-2 xs:mt-4 2xs:mt-4 3xs:mt-3 rounded font-roboto cursor-pointer transition-all duration-200 hover:bg-violet-600">Login</button>
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-primary px-4 h-screen">
      <div className="bg-secondary p-4 rounded-3xl shadow-2xl shadow-zinc-800 xl:w-[70%] lg:w-[90%] md:w-[99%] sm:w-[90%] xs:w-[90%] 2xs:w-[95%] 3xs:w-[99%] grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xl:items-center lg:items-center md:items-center sm:items-start gap-4 ">
        <div className="w-full relative"> 
            <img src={authpic} alt="Logo" className="w-full xl:h-full lg:h-full md:h-full sm:h-[40vh] xs:h-[40vh] rounded-3xl" />
            ...
            <div className="absolute bottom-10 text-2xl xl:left-36 lg:left-24 md:left-14 sm:left-36 xs:left-14 2xs:left-10 3xs:left-4 text-white text-center font-roboto font-extralight">
        ...
        <div className="xl:p-10 lg:p-4 h-[70%] flex flex-col justify-between">
          <div className="flex justify-between items-center mb-5">
            <h1 className="text-white xl:text-4xl lg:text-3xl md:text-2xl sm:text-3xl xs:text-xl 2xs:text-xl 3xs:text-sm font-roboto ">
